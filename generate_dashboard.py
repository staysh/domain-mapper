def generate_dashboard(output_file="index.html", map_file="site_map.html", hop_file="hop_finder.html"):
    html_content = f"""<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Domain Mapper Dashboard</title>
    <style>
        * {{ box-sizing: border-box; margin: 0; padding: 0; }}
        ...
        .title {{ font-weight: bold; font-size: 15px; margin-right: 20px; color: #f8fafc; letter-spacing: 0.5px; }}
...
<body>
    ...
    <div class="nav-bar">
        <span class="title">🌐 DOMAIN MAPPER</span>
    ...
    <div class="content-area">
        <iframe id="mapFrame" src="{map_file}" class="active"></iframe>
        <iframe id="hopFrame" src="{hop_file}"></iframe>
    </div>
